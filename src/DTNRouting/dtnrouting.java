...
public class dtnrouting extends Applet implements Runnable
{
	...
	public static String  movementtype="Random";
	public static int     total_packetsDeliveredExpired=0, SIMULATION_PART=1, SIMULATION_N0=20, TOTAL_SIMULATION_RUNS=1;
	...
	//******************************************************************************
	// CSV Files
	/*	WriteFile UserRequirements_wrt_NetworkMetricValues, SrcDstPath, SrcDstPath_usingUAVs, NetworkMetricValues_SelectedSource;
	WriteFile NetworkMetricValues_SelectedSource_usingUAVs, QualityMetricsScore_SelectedSource, QualityMetricsScore_SelectedSource_usingUAVs;
	WriteFile PNP_SelectedSource, PNP_SelectedSource_usingUAVs;*/
	
	//Performance-------------------------------------------------------------
	public static String folder="/Users/mahrukh/Results/";
	...
	String pnp_SelectedSource_usingUAVs = folder+"PNP_SelectedSource_usingUAVs.csv";
	WriteFile PNP_SelectedSource_usingUAVs = new WriteFile(pnp_SelectedSource_usingUAVs, true);
	...
	public static ArrayList<Node>   liveNodes=new ArrayList<Node>();            // contains all nodes i.e source + destination + relay // LIVE NODES
	public static ArrayList<Node>   allNodes=new ArrayList<Node>();              // contains all nodes i.e source + destination + relay // LIVE NODES
	public static ArrayList<Packet> arePacketsDelivered=new ArrayList<Packet>();
	public static ArrayList<Node>   liveSources=new ArrayList<Node>();				 // contains only source nodes
	public static ArrayList<Node>   liveDestinations=new ArrayList<Node>();			 // contains only destination nodes
	public static ArrayList<Node>   TransferNodes=new ArrayList<Node>();			 // contains only destination nodes
	public static ArrayList<Node>   deadNodes=new ArrayList<Node>();			 // contains only destination nodes
	public static ArrayList<Node>   allSources=new ArrayList<Node>();				 // contains only source nodes
	public static ArrayList<Node>   allDestinations=new ArrayList<Node>();			 // contains only destination nodes
	//******************************************************************************
	...
	public void init()
	{
		...
		addComponents_Panel2();
		  ...
		  try{
		     ...
		     performanceFile.println("Run, Part, Dest, Source,TotalPackets, PacketID,Hops,Latency,Reliability,Delivered");
		  }
		  catch( IOException e ){
